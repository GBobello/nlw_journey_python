...
from src.models.repositories import participants_repository
...
from src.controllers.paticipant_creator import ParticipantCreator
...
def confirm_invite(participantId):
    conn = db_connection_handler.get_connection()
    participants_repository_repository = ParticipantsRepository(conn)
    controller = ParticipantConfirmer(participants_repository_repository)
